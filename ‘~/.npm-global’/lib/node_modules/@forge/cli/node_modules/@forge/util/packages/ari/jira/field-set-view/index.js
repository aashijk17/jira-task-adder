...
var field_set_view_exports = {};
__export(field_set_view_exports, {
  JiraFieldSetViewAri: () => JiraFieldSetViewAri,
  JiraFieldSetViewAriResourceOwner: () => JiraFieldSetViewAriResourceOwner,
  JiraFieldSetViewAriResourceType: () => JiraFieldSetViewAriResourceType
});
module.exports = __toCommonJS(field_set_view_exports);
...
0 && (module.exports = {
  JiraFieldSetViewAri,
  JiraFieldSetViewAriResourceOwner,
  JiraFieldSetViewAriResourceType
});
