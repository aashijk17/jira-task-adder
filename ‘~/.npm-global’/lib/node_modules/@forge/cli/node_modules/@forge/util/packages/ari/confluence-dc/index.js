...
// src/confluence-dc/index.ts
var confluence_dc_exports = {};
__export(confluence_dc_exports, {
  ConfluenceDcCommentAri: () => ConfluenceDcCommentAri,
  ConfluenceDcDocumentAri: () => ConfluenceDcDocumentAri,
  ConfluenceDcSpaceAri: () => ConfluenceDcSpaceAri
});
module.exports = __toCommonJS(confluence_dc_exports);
...
// src/confluence-dc/comment/types.ts
var ConfluenceDcCommentAriResourceOwner = "confluence-dc", ConfluenceDcCommentAriResourceType = "comment";

// src/confluence-dc/comment/manifest.ts
var confluenceDcCommentAriStaticOpts = {
  qualifier: "ari",
  platformQualifier: "third-party",
  cloudId: new RegExp("^$"),
  // eslint-disable-line no-useless-escape
  resourceOwner: ConfluenceDcCommentAriResourceOwner,
  resourceType: ConfluenceDcCommentAriResourceType,
...
// src/confluence-dc/comment/index.ts
var ConfluenceDcCommentAri = class _ConfluenceDcCommentAri extends RegisteredAri {
  constructor(opts) {
    super(opts);
  ...
  static create(opts) {
    let derivedOpts = {
      qualifier: confluenceDcCommentAriStaticOpts.qualifier,
      platformQualifier: confluenceDcCommentAriStaticOpts.platformQualifier,
      cloudId: void 0,
      resourceOwner: confluenceDcCommentAriStaticOpts.resourceOwner,
      resourceType: confluenceDcCommentAriStaticOpts.resourceType,
      resourceId: `${opts.siteId}/${opts.commentId}`,
      resourceIdSegmentValues: {
        siteId: opts.siteId,
        commentId: opts.commentId
      }
    }, ariOpts = AriParser.fromOpts(derivedOpts, confluenceDcCommentAriStaticOpts);
    return new _ConfluenceDcCommentAri(ariOpts);
  }
  static parse(maybeAri) {
    let opts = AriParser.fromString(maybeAri, confluenceDcCommentAriStaticOpts);
    return new _ConfluenceDcCommentAri(opts);
  }
  getVariables() {
    return {
      siteId: this.siteId,
...
// src/confluence-dc/document/types.ts
var ConfluenceDcDocumentAriResourceOwner = "confluence-dc", ConfluenceDcDocumentAriResourceType = "document";

// src/confluence-dc/document/manifest.ts
var confluenceDcDocumentAriStaticOpts = {
  qualifier: "ari",
  platformQualifier: "third-party",
  cloudId: new RegExp("^$"),
  // eslint-disable-line no-useless-escape
  resourceOwner: ConfluenceDcDocumentAriResourceOwner,
  resourceType: ConfluenceDcDocumentAriResourceType,
...
// src/confluence-dc/document/index.ts
var ConfluenceDcDocumentAri = class _ConfluenceDcDocumentAri extends RegisteredAri {
  constructor(opts) {
    super(opts);
  ...
  static create(opts) {
    let derivedOpts = {
      qualifier: confluenceDcDocumentAriStaticOpts.qualifier,
      platformQualifier: confluenceDcDocumentAriStaticOpts.platformQualifier,
      cloudId: void 0,
      resourceOwner: confluenceDcDocumentAriStaticOpts.resourceOwner,
      resourceType: confluenceDcDocumentAriStaticOpts.resourceType,
    ...
    }, ariOpts = AriParser.fromOpts(derivedOpts, confluenceDcDocumentAriStaticOpts);
    return new _ConfluenceDcDocumentAri(ariOpts);
  }
  static parse(maybeAri) {
    let opts = AriParser.fromString(maybeAri, confluenceDcDocumentAriStaticOpts);
    return new _ConfluenceDcDocumentAri(opts);
  }
  getVariables() {
    return {
      siteId: this.siteId,
...
// src/confluence-dc/space/types.ts
var ConfluenceDcSpaceAriResourceOwner = "confluence-dc", ConfluenceDcSpaceAriResourceType = "space";
...
0 && (module.exports = {
  ConfluenceDcCommentAri,
  ConfluenceDcDocumentAri,
