...
const FORGE_UI_HOOK_PERMISSIONS = {
    useContentProperty: {
        beta: ['read:page:confluence', 'write:page:confluence'],
        current: ['read:page:confluence', 'write:page:confluence']
    },
    useSpaceProperty: {
        beta: ['read:space:confluence', 'write:space:confluence'],
        current: ['read:space:confluence', 'write:space:confluence']
    },
    useIssueProperty: {
