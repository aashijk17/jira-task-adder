...
export interface ArtifactClient {
    getUploadUrl(appDetails: AppDetails, buildTag?: string): Promise<string>;
    getHostedResourcesUploadUrls(appDetails: AppDetails, resourceKeys: string[], environmentKey?: string, buildTag?: string): Promise<HostedResourceUploadResponse>;
}
