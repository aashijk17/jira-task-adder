...
export interface ArchiveUploader {
    uploadArchive(archivePath: string, buildTag?: string): Promise<string>;
    uploadHostedResources(resourceArchives: ResourceArchives, environmentKey?: string, buildTag?: string): Promise<string | undefined>;
}
