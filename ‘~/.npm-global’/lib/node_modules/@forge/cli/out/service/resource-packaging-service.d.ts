...
import { FileSystemReader, ResourceDetails, BridgeScriptService, IframeResizerScriptService, UserError, type I18nResourceBundle } from '@forge/cli-shared';
...
export declare class ResourcePackagingService {
    ...
    private packageI18nResources;
    zipResources(resources: ResourceDetails[], i18nResourceBundle: I18nResourceBundle, modules?: Modules): Promise<ResourceArchives>;
}
