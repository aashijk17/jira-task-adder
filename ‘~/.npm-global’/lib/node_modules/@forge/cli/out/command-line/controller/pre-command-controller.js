...
class PreCommandController {
    ...
    settingsView;
    statsigService;
    constructor(service, view, configReader, cachedConfigService, analyticsSettingsView, settingsView, statsigService) {
    ...
    async runChecks(strict) {
        const report = await this.service.run(strict, this.view.getLogger(), this.statsigService);
