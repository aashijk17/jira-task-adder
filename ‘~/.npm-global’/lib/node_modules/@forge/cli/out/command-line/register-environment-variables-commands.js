...
const registerSetEnvironmentVariableCommand = ({ cmd, ui, commands: { setEnvironmentVariableCommand }, controllers: { defaultEnvironmentController } }) => {
    cmd
        ...
        const defaultEnvironment = await defaultEnvironmentController.getDefaultEnvironment();
        ui.info(cli_shared_1.Text.varsSet.cmd.deployTip(environment === defaultEnvironment ? undefined : environment));
    });
};
